...
RSpec.describe Event, type: :model do
  ...
  let(:end_before_start_event) { Event.new(name: "EndBeforeStart", starts_at: DateTime.new(2001, 02, 03, 04, 05, 06), ends_at: DateTime.new(2001, 01, 03, 07, 05, 06)) }
  ...
  let(:multi_day_event) { Event.new(name: "MultiDayEvent", starts_at: DateTime.new.beginning_of_day, ends_at: DateTime.new.end_of_day) }
